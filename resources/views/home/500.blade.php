...
<nav id="nav">
    <ul>
        <li><a href="{{asset("index")}}" class="active">首页</a></li>
        <li><a href="{{asset("item_food")}}">生活餐饮</a></li>
        <li><a href="{{asset("itemCat")}}">学习用品</a></li>
...
<div id="container">
    <div class="rightsidebar_box rt" >
        <div class="sys_err">
            <img src="{{asset("images/500/500_img1.png")}}" alt=""/>
            <p>
                <img src="{{asset("images/500/500_img2.png")}}" alt=""/>服务器发生了错误！
            </p>
            ...
            <div id="demo1" style="float:left"><!-- 第一个宽度显示 -->
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <img src="{{asset("images/recommend/recommend_img1.png")}}" border="0">
                    </div>
                    <p>ThinkPad New S2 (20GUA00QCD)13.3英寸超霸笔记本电脑</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <img src="{{asset("images/recommend/recommend_img2.png")}}" border="0">
                    </div>
                    <p>戴尔 DELL燃7000 R1605S 超霸笔记本电脑</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <img src="{{asset("images/recommend/recommend_img3.png")}}" border="0">
                    </div>
                    <p>戴尔(DELL)魔方15MF Pro-R2505TSS灵越超霸笔记本电脑</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <img src="{{asset("images/recommend/recommend_img4.png")}}" border="0">
                    </div>
