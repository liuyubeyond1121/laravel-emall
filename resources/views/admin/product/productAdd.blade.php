...
<div class="page-container">
	<form action="{{asset('admin/product')}}" method="post" class="form form-horizontal" id="form-article-add">
		{{csrf_field()}}
		<div class="row cl">
...
<script type="text/javascript" src="{{asset("admin/lib/webuploader/0.1.5/jquery.uploadify.min.js")}}"></script>
...
//            server: '__MODULE__/Product/fileUpload',
            server: '{{asset('emall/fileupload.php')}}',
            // runtimeOrder: 'flash',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('{{asset('Admin/lib/webuploader/0.1.5/server/preview.php')}}', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
