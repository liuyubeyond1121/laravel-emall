	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<tr class="text-c">
				...
				<td><a href="<?php echo e(url('admin/ordersDetail').'?code='.$v->code); ?>"><?php echo e($v->code); ?></a></td>
				<td><a href="javascript:;" onclick="member_show('<?php echo e($v->getUsername->username); ?>','<?php echo e(asset('admin/user/'.$v->id)); ?>','360','400')"><?php echo e($v->getUsername->username); ?></a></td>
				<td><a href="javascript:;" onclick="member_show('<?php echo e($v->getRecName->sname); ?>','<?php echo e(asset('admin/ordersAddress?id='.$v->getRecName->id)); ?>','500','400')"><?php echo e($v->getRecName->sname); ?></a></td>
				<td><?php echo e($v->addtime); ?></td>
				<td><?php echo e($v->getStatus->name); ?></td>
				<td>
					<?php if($v->status == 6): ?>
						<a href="javascript:;" >修改状态</a>
					<?php else: ?>
						<a href="javascript:;" onclick="member_show('订单状态修改','<?php echo e(url('admin/ordersEdit?status='.$v->status.'&code='.$v->code)); ?>','400','300')">修改状态</a>
					<?php endif; ?>
				</td>
			</tr>
