...
<div class="page-container">
	...
	<p>登录次数：<?php echo e(session('manager')->count); ?></p>
	<p>上次登录IP：<?php echo e(session('manager')->ipaddr); ?>  上次登录时间：<?php echo e(session('manager')->lasttime); ?></p>
	...
	<table class="table table-border table-bordered table-bg mt-20">
		...
		<tbody>
			<tr>
				...
				<td><span id="lbServerName"><?php echo e($_SERVER['APP_URL']); ?></span></td>
			</tr>
			<tr>
				<td>服务器IP地址</td>
			...
			<tr>
				<td>服务器当前时间 </td>
				<td><?php echo e(date('Y年m月d日 H:i:s',time())); ?></td>
			</tr>
			<tr>
				<td>服务器IE版本 </td>
				<td>6.0000</td>
