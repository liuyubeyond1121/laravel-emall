...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray"> <span class="l">
		<a href="<?php echo e(asset("admin/javascript:;")); ?>" onclick="datadel()" class="btn btn-danger radius">
			<i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
		<a class="btn btn-primary radius" href="<?php echo e(asset("admin/javascript:;")); ?>" onclick="admin_role_add('添加角色','__MODULE__/Admin/adminRoleAdd','800')">
	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<tr class="text-c">
				...
				<td><a href="#">
					<?php $__currentLoopData = $v->getUsername; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $username): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
