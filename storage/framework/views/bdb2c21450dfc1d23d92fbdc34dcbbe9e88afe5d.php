...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius">
		...
		<a class="btn btn-primary radius" onclick="picture_add('添加图片','<?php echo e(asset('admin/slider/create')); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加图片</a></span>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr class="text-c">
					...
					<td><?php echo e($v->orders); ?></td>
					<td><img width="120px" class="picture-thumb" src="<?php echo e(asset("admin/upload").'/'.$v->image); ?>"></td>
					<td><?php echo e($v->title); ?></td>
					<td><?php echo e($v->href); ?></td>
					<td class="td-manage">
						<a style="text-decoration:none" class="ml-5" onClick="picture_edit('轮播图编辑','<?php echo e(asset('admin/slider/'.$v->id.'/edit')); ?>')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a style="text-decoration:none" class="ml-5" onClick="picture_del(this,'<?php echo e($v->id); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
...
function picture_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'delete',
			url: "<?php echo e(asset('admin/slider/'.$v->id)); ?>",
			dataType: 'json',
