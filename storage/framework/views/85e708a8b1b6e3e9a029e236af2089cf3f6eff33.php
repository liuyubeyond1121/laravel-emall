...
<div class="parent">
  <!--<video src="<?php echo e(asset("audio/snow.mp4")); ?>" width="100%" autoplay loop muted></video>-->
  <div class="container">
    <div class="panel rt">
      <form id="form-register" method="post" action="">
        <div class="txt">
          <p>新用户注册
            <span>
              <a href="<?php echo e(asset("login.html")); ?>">直接登录</a>
            </span>
          </p>
        </div>
...
<div id="foot_box">
  <div class="icon1 lf">
    <img src="<?php echo e(asset("images/footer/icon1.png")); ?>" alt=""/>

    <h3>品质保障</h3>
  </div>
  <div class="icon2 lf">
    <img src="<?php echo e(asset("images/footer/icon2.png")); ?>" alt=""/>

    <h3>私人定制</h3>
  </div>
  <div class="icon3 lf">
    <img src="<?php echo e(asset("images/footer/icon3.png")); ?>" alt=""/>

    <h3>学员特供</h3>
  </div>
  <div class="icon4 lf">
    <img src="<?php echo e(asset("images/footer/icon4.png")); ?>" alt=""/>
...
<div class="foot_bj">
  <div id="foot">
    <div class="lf">
      <p class="footer1"><img src="<?php echo e(asset("images/footer/logo.png")); ?>" alt="" class=" footLogo"/></p>
      <p class="footer2"><img src="<?php echo e(asset("images/footer/footerFont.png")); ?>"alt=""/></p>
    ...
    <div class="foot_left lf" >
      ...
      <ul>
        ...
        <li><a href="#">联系我们</a></li>
        <li>
          <img src="<?php echo e(asset("images/footer/wechat.png")); ?>" alt=""/>
          <img src="<?php echo e(asset("images/footer/sinablog.png")); ?>" alt=""/>
        </li>
      </ul>
    </div>
    <div class="service">
      <p>阿甲商城客户端</p>
      <img src="<?php echo e(asset("images/footer/ios.png")); ?>" class="lf">
      <img src="<?php echo e(asset("images/footer/android.png")); ?>" alt="" class="lf"/>
    </div>
    <div class="download">
      <img src="<?php echo e(asset("images/footer/erweima.png")); ?>">
    </div>
	<!-- 页面底部-备案号 #footer -->
      <div class="record">
