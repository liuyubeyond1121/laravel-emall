...
<div class="ck-slide">
    <ul class="ck-slide-wrapper">
        <li>
            <a href="<?php echo e(asset("product_details")); ?>"><img src="<?php echo e(asset("images/index/index_banner1.png")); ?>" alt=""></a>
        </li>
        <li style="display:none">
            <a href="<?php echo e(asset("product_details")); ?>"><img src="<?php echo e(asset("images/index/index_banner2.png")); ?>" alt=""></a>
        </li>
        <li style="display:none">
            <a href="<?php echo e(asset("product_details")); ?>"><img src="<?php echo e(asset("images/index/index_banner3.png")); ?>" alt=""></a>
        </li>
        <li style="display:none">
            <a href="<?php echo e(asset("product_details")); ?>"><img src="<?php echo e(asset("images/index/index_banner4.png")); ?>" alt=""></a>
        </li>
        <li style="display:none">
            <a href="<?php echo e(asset("product_details")); ?>"><img src="<?php echo e(asset("images/index/index_banner5.png")); ?>" alt=""></a>
        </li>
    </ul>
...
<div id="product">
    <div class="product_1 lf">
        <div class="aside lf">
            <img id="aside_image" src="<?php echo e(asset("images/index/index_Sbanner_img1.png")); ?>" alt=""/>
        </div>
        <div class="text rt">
    ...
    <div class="product_2 lf">
        ...
        <div class="aside lf">
            <img id="aside_image2" src="<?php echo e(asset("images/index/index_Sbanner_img2.png")); ?>" alt=""/>
        </div>
        <div class="text rt">
    ...
    <div class="product_3 lf">
        <div class="aside lf">
            <img id="aside_image3" src="<?php echo e(asset("images/index/index_Sbanner_img3.png")); ?>" alt=""/>
        </div>
        <div class="text rt">
            <p class="ys1">刀鱼焖排骨</p>
...
<!-- welcome部分-->
<div id="welcome">
    <a href="<?php echo e(asset("")); ?>">阅读更多>></a>
</div>
<!-- 学习用品-->
<div id="study">
    ...
    <div class="study_left lf">
        <div id="product_parameters_main">
            <p><img src="<?php echo e(asset("images/index/wenan.png")); ?>" alt=""/></p>
            ...
            <p class="view_details"><a href="<?php echo e(asset("product_details")); ?>">查看详情</a></p>
        </div>
        <img id="study_product_main" src="<?php echo e(asset("images/index/index_hot_study_img1.png")); ?>" alt=""/>
    </div>
    <div class="study_right rt">
        <div class="right_top">
            ...
            <img id="study_product_vice1" src="<?php echo e(asset("images/index/index_hot_study_img2.png")); ?>" alt=""/>
        </div>
        <div class="right_bottom">
            <div id="product_parameters_vice2">
                ...
                <p class="view_details"><a href="<?php echo e(asset("product_details")); ?>" >查看详情</a></p>
                <img id="study_product_vice2" src="<?php echo e(asset("images/index/index_hot_study_img3.png")); ?>" alt=""/>
            </div>
        </div>
    </div>
</div>
...
<div id="gourmet">
    ...
    <div class="food_detail rt">
        <div>
            <div class="food1 lf">
                <img src="<?php echo e(asset("images/index/index_hot_food_img1.png")); ?>" alt=""/>

                <h2>红烧肉盖饭套餐<span> (吉野家) </span></h2>

                <p>￥20.00</p>
                <a href="<?php echo e(asset("item_food")); ?>">立即订餐</a>
            </div>
            <div class="food1 lf">
                <img src="<?php echo e(asset("images/index/index_hot_food_img2.png")); ?>" alt="" id="food1"/>
            ...
            <div class="food1 lf" >
                <img src="<?php echo e(asset("images/index/index_hot_food_img3.png")); ?>" alt=""/>
