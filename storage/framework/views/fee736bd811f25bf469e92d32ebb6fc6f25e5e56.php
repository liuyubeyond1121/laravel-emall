...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
			<a href="javascript:;" onclick="member_add('添加分类','<?php echo e(asset('admin/category/create')); ?>','','510')" class="btn btn-primary radius">
			<i class="Hui-iconfont">&#xe600;</i> 添加分类</a></span> <span class="r">共有数据：<strong id="count"><?php echo e(count($data)); ?></strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<tr class="text-c">
				...
				<td style="text-align: left;"><?php echo e(str_repeat('|==',$v->level-1)); ?><?php echo e($v->name); ?></td>
				<td><?php echo e($v->level); ?>级分类</td>
				<td><?php echo e($v->sort); ?></td>

				
				
				
				<td><a href="javascript:;" onclick="member_add('添加子类','<?php echo e(asset('admin/category/create')); ?>?parentId=<?php echo e($v->id); ?>&parentIdPath=<?php echo e($v->parentIdPath); ?>_<?php echo e($v->id); ?>','','510')" class="btn btn-info radius"><i class="Hui-iconfont">&#xe600;</i> 添加子类</a></td>
				
				<td>
					<a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo e(asset('admin/category/'.$v->id.'/edit')); ?>','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
					<a title="删除"  href="javascript:;" onclick="member_del('<?php echo e(url('admin/category').'/'.$v->id); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
...
function member_stop(obj,id){
	layer.confirm('确认要停用吗？',function(index){
		$.ajax({
			type: 'get',
			url: '<?php echo e(asset('admin/category/userStop')); ?>/'+id,
			dataType: 'json',
...
function member_start(obj,id){
	layer.confirm('确认要启用吗？',function(index){
		$.ajax({
			type: 'get',
			url: '<?php echo e(asset('admin/category/userStart')); ?>/'+id ,
			dataType: 'json',
			success: function(data){
			    if(data==true){
...
function member_del(url){
	layer.confirm('确认要删除吗？',function(index){
		//可以用post方法模拟delete
		$.post(url,{'_token':'<?php echo e(csrf_token()); ?>','_method':'delete'},function(data){
			if(data){
			    location.reload() ;
			}
        }) ;
